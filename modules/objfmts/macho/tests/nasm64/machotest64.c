...
main(void)
{
    ...
    printf(
        "Testing lrotate: should get 0x0000000000400000, 0x0000000000000001\n");
    ...
    commvar = 4321;
    greet();
    printf("The absolute addressing to the asm-local integer should yield in "
           "1235:\n%ld\n",
           readgreet());
...
*/
void
druck(char *string, int a, int b, int c)
{
    printf(string, a, b, c);
}
