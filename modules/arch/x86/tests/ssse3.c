...
static void
test_pabsb_c(char *pDst, char *pSrc, int xmm)
{
    int i;
...
static void
test_pabsw_c(short *pDst, short *pSrc, int xmm)
{
    int i;
...
static void
test_pabsd_c(int *pDst, int *pSrc, int xmm)
{
    int i;
...
static void
test_psignb_c(char *pDst, char *pSrc, int xmm)
{
    int i;
...
static void
test_psignw_c(short *pDst, short *pSrc, int xmm)
{
    int i;
...
static void
test_psignd_c(int *pDst, int *pSrc, int xmm)
{
    int i;
...
static void
test_phaddw_c(unsigned short *pDst, unsigned short *pSrc, int xmm)
{
    int i;
...
static void
test_phaddsw_c(short *pDst, short *pSrc, int xmm)
{
    int i;
...
static void
test_phaddd_c(unsigned int *pDst, unsigned int *pSrc, int xmm)
{
    int i;
...
static void
test_phsubw_c(unsigned short *pDst, unsigned short *pSrc, int xmm)
{
    int i;
...
static void
test_phsubsw_c(short *pDst, short *pSrc, int xmm)
{
    int i;
...
static void
test_phsubd_c(unsigned int *pDst, unsigned int *pSrc, int xmm)
{
    int i;
...
static void
test_pmulhrsw_c(short *pDst, short *pSrc, int xmm)
{
    int i;
...
static void
test_pmaddubsw_c(unsigned char *pDst, signed char *pSrc, int xmm)
{
    int i;
...
static void
test_pshufb_c(unsigned char *pDst, unsigned char *pSrc, int xmm)
{
...
static void
test_palignr_c(unsigned char *pDst, unsigned char *pSrc, int xmm)
{
    int i;
...
static void
randomize_args(unsigned char *pDst, unsigned char *pSrc)
{
    int j;
    for (j = 0; j < 16; j++) {
        pDst[j] = rand() % 256;
